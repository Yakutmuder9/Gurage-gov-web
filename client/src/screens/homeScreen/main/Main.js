...
const MainScreen = () => {
    return (
        <div className="w-100 MainScreen">
            <div>
                <ul className="MainScreenList d-flex align-items-center justify-content-between w-100  py-2 pe-2 list-none" >
            ...
            <div className="mainbg w-100 h-100 d-md-flex d-block" >
                <div className="clipSide p w-50 h-100  d-none d-md-flex align-items-center justify-content-end" >
                    ...
                    <h1 className="welcometxt text-light text-center overflow-hidden ">WELLCOME TO GURAGE <br /> REGIONAL STATE </h1>
                ...
                <div className="ImgSide px-4 py-5 w-100 h-100 d-block d-md-flex align-items-center justify-content-end">
                    <h1 className="text-light text-center overflow-hidden d-md-none">WELLCOME TO GURAGE <br /> REGIONAL STATE </h1>
                </div>
            </div>
        </div>
    )
